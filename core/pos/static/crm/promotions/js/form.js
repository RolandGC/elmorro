...
$(function () {
    ...
    $('#tblProducts tbody')
        ...
        .on('change', 'input[name="dscto"]', function () {
            ...
            $('td:eq(5)', tblProducts.row(tr.row).node()).html('S/.' + promotions.details.products[tr.row].total_dscto.toFixed(2));
            $('td:eq(6)', tblProducts.row(tr.row).node()).html('S/.' + promotions.details.products[tr.row].price_final.toFixed(2));
        })
