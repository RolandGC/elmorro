...
function getData(all) {
    ...
    tblExpenseSeries = $('#data').DataTable({
        responsive: true,
        autoWidth: false,
        destroy: true,
        deferRender: true,
...
$(function () {
    ...
    $('#data tbody')
        ...
        .on('click', 'a[rel="delete"]', function (e) {
            e.preventDefault();
            var tr = tblExpenseSeries.cell($(this).closest('td, li')).index();
            var row = tblExpenseSeries.row(tr.row).data();
            var deleteUrl = '/pos/frm/expense_series/delete/' + row.id + '/';
        ...
        .on('click', 'a[rel="edit"]', function (e) {
            ...
            var tr = tblExpenseSeries.cell($(this).closest('td, li')).index();
            var row = tblExpenseSeries.row(tr.row).data();
            window.location.href = '/pos/frm/expense_series/update/' + row.id + '/';
        });
});
