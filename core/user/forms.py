...
class UserForm(ModelForm):
    ...
    class Meta:
        model = User
        fields = 'full_name', 'username', 'password', 'dni', 'email', 'groups', 'image', 'is_active'
        widgets = {
            'full_name': forms.TextInput(attrs={'placeholder': 'Ingrese sus nombres completos'}),
            'username': forms.TextInput(attrs={'placeholder': 'Ingrese un username'}),
            'dni': forms.TextInput(attrs={'placeholder': 'Ingrese su número Dni o Ruc'}),
...
class ProfileForm(ModelForm):
    ...
    class Meta:
        model = User
        fields = 'full_name', 'username', 'dni', 'email', 'image'
        widgets = {
            'full_name': forms.TextInput(attrs={'placeholder': 'Ingrese sus nombres completos'}),
            'username': forms.TextInput(attrs={'placeholder': 'Ingrese un username'}),
